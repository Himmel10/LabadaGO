  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        {['delivered', 'paid', 'completed'].includes(order.status) && !order.shopRating && user?.role === 'customer' && order.customerId === user?.id && !showReviewForm && (
...
const styles = StyleSheet.create({
  ...
  confirmCard: {
    backgroundColor: Colors.warningLight, borderRadius: 14, padding: 18, marginBottom: 20,
    borderWidth: 0,
    borderLeftWidth: 4,
  ...
  ratingCard: {
    backgroundColor: Colors.white, borderRadius: 14, padding: 16, marginBottom: 16, alignItems: 'center',
    borderWidth: 0,
    shadowColor: '#000',
    shadowOffset: { width: 0, height: 2 },
    shadowOpacity: 0.08,
